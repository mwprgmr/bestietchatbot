-- ============================================================
-- BESTIET FRESH: ATOMIC ORDER CREATION & TIMEZONE SYNC FIX
-- ============================================================

-- Ensure composite unique constraint on inventory (branch_id, product_id, inventory_date)
...
-- Atomic Order Creation Procedure
...
DECLARE
    ...
    v_product_name TEXT;
    v_branch_name TEXT;
    -- Always resolve business date in Asia/Kolkata timezone if not explicitly provided
...
BEGIN
    ...
    -- Generate unique order number (e.g. BF-20260831-4921)
    LOOP
