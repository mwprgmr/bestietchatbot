-- ============================================================
-- BESTIET FRESH: MIGRATION 012 - PRODUCTION CHECKOUT & INVENTORY FIXES
-- ============================================================

-- 1. Ensure composite unique constraint on inventory (product_id, branch_id, inventory_date)
...
-- 2. Create / Update Branch-Aware Stock Reservation Function
...
-- 3. Create Branch-Isolated Available Inventory Helper Function
