...
export default function ProductsPage() {
  ...
  // Dynamically aggregate all existing product categories
  const defaultCategories = ['Fish', 'Shellfish', 'Crustacean', 'Specialty']
                ...
                <div>
                  <div className="flex items-center justify-between mb-1">
                    ...
                    {!isCustomCategoryMode ? (
                      ...
                      <button
                        ...
                        onClick={() => {
                          setIsCustomCategoryMode(false)
                          setFormData({ ...formData, category: existingCategories[0] || 'Fish' })
                        }}
                  ...
                  {!isCustomCategoryMode ? (
                    ...
                    <input
                      ...
                      placeholder="e.g. Exotic, Dried Fish..."
                      className="w-full px-3 py-2 bg-emerald-50/50 border border-emerald-300 rounded-xl text-xs font-medium focus:bg-white focus:ring-2 focus:ring-emerald-500 focus:outline-none placeholder:text-slate-400"
                    />
                  )}
                </div>
