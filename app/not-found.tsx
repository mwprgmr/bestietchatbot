  ...
  return (
    <StorefrontLayout>
      <div className="py-16 px-4 text-center max-w-lg mx-auto space-y-6">
        <div className="w-20 h-20 bg-[#39B54A]/20 text-[#39B54A] rounded-full flex items-center justify-center mx-auto border border-[#39B54A]/30">
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-3 pt-2">
          <Link
            href="/"
            className="w-full sm:w-auto px-6 py-3 bg-[#39B54A] hover:bg-[#2EA03E] text-white font-bold text-xs rounded-xl shadow-md transition-all flex items-center justify-center gap-2"
          >
          ...
          >
            <Search className="w-4 h-4 text-[#39B54A]" />
