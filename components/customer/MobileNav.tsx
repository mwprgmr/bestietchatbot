      ...
      <nav className="bg-white/95 border-t border-slate-200/80 pt-2.5 pb-[max(0.75rem,env(safe-area-inset-bottom))] px-2 flex items-center justify-around text-slate-600 shadow-2xl">
        ...
        <Link
          ...
          className={`flex flex-col items-center gap-1 text-[10px] font-bold py-1 px-3 rounded-xl transition-all active:scale-95 cursor-pointer ${
            pathname === '/' ? 'text-[#39B54A] bg-[#39B54A]/10' : 'hover:text-slate-900'
          }`}
        >
        ...
        <Link
          ...
          className={`flex flex-col items-center gap-1 text-[10px] font-bold py-1 px-3 rounded-xl transition-all active:scale-95 cursor-pointer ${
            pathname?.startsWith('/category') ? 'text-[#39B54A] bg-[#39B54A]/10' : 'hover:text-slate-900'
          }`}
        >
        ...
        <Link
          href="/search"
          className={`flex flex-col items-center gap-1 text-[10px] font-bold py-1 px-3 rounded-xl transition-all active:scale-95 cursor-pointer ${
            pathname === '/search' ? 'text-[#39B54A] bg-[#39B54A]/10' : 'hover:text-slate-900'
          }`}
        >
        ...
        <Link
          href="/orders"
          className={`flex flex-col items-center gap-1 text-[10px] font-bold py-1 px-3 rounded-xl transition-all active:scale-95 cursor-pointer ${
            pathname === '/orders' ? 'text-[#39B54A] bg-[#39B54A]/10' : 'hover:text-slate-900'
          }`}
        >
        ...
        <Link
          ...
          className={`flex flex-col items-center gap-1 text-[10px] font-bold relative py-1 px-3 rounded-xl transition-all active:scale-95 cursor-pointer ${
            isCartPage || isCartOpen ? 'text-[#39B54A] bg-[#39B54A]/10' : 'hover:text-[#39B54A]'
          }`}
        >
          <div className="relative">
            <ShoppingBag className="w-5 h-5" />
            {totalItems > 0 && (
              <span className="absolute -top-1.5 -right-2.5 bg-[#39B54A] text-white text-[9px] font-black w-4 h-4 rounded-full flex items-center justify-center border-2 border-white shadow-2xs">
                {totalItems}
              </span>
            )}
          </div>
